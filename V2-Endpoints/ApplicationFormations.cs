...
{
    /// <summary>
    /// This class represents the DrillingInfo V2 Application Formations endpoint. Each property in the class represents a data column for the endpoint, matching it by name.
    /// </summary>
    public class ApplicationFormations
    {
