...
{
    /// <summary>
    /// This class represents the DrillingInfo V1 Landtrac Leases endpoint. Each property in the class represents a data column for the endpoint, matching it by name.
    /// </summary>
    public class LandtracLeases
    {
        ...
        public double? extension_term_month { get; set; }
